  ...
  return (
    <>
      <motion.div
        ...
        className="mt-10 px-10 lg:px-0 lg:my-32 lg:w-[80%] lg:mx-auto lg:flex items-center justify-between"
      >
        <div className="flex flex-col items-center lg:items-start justify-center gap-6">
          <motion.h1
            ...
            initial="hidden"
            whileInView="show"
            className="font-bold text-4xl text-center lg:text-5xl md:text-left"
          >
          ...
          >
            <Button
              className="bg-gradient-to-tr from-purple-800 to-pink-600 text-white font-semibold rounded-full text-center"
